# Esg Report Parser — Standalone Real GUI Implementation
...
Default URL: `http://127.0.0.1:9120`

## What is inside this project folder

- `app/` — FastAPI backend for this project.
- `static/` — elegant browser GUI.
- `plugins/esg-report-parser.json` — this project’s own feature/customization/input schema.
...
- `evidence_requirement` — evidence requirement (text)
...
- `sustainability_pdf` — Sustainability PDF (text) required
